...
{
    public class ProductSliderObjectContext : DbContext, IDbContext
    {

        #region Ctor


        public ProductSliderObjectContext(DbContextOptions<ProductSliderObjectContext> options) : base(options)
        {
        }
        ...
        {
            modelBuilder.ApplyConfiguration(new ProductSliderMap());
        ...
        {
            //drop the table
            this.DropPluginTable("ProductSlider");
