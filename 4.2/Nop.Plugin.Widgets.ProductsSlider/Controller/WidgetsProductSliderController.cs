...
using Nop.Plugin.Widgets.ProductsSlider.Factories;
...
namespace Nop.Plugin.Widgets.ProductsSlider.Controller
{
    ...
    public class WidgetsProductSliderController : BasePluginController
    {
        ...
        private readonly IProductSliderModelFactory _productSliderModelFactory;
        #endregion
        ...
        public WidgetsProductSliderController(IRepository<ProductSlider> productSliderRepository, ILocalizationService localizationService, IPermissionService permissionService, IStoreService storeService, IStoreMappingService storeMappingService, IProductSliderService productSliderService, ILanguageService languageService, ICustomerActivityService customerActivityService, ILocalizedEntityService localizedEntityService
            ...
            , INotificationService notificationService, IProductSliderModelFactory productSliderModelFactory)
        {
            ...
            _productSliderModelFactory = productSliderModelFactory;
        }
        #region Utilities
        ...
        {
            return RedirectToAction("~/Plugins/Widgets.ProductsSlider/Views/List.cshtml");
        }
        public virtual IActionResult List()
        {
            ...
            //{
            //   _notificationService.WarningNotification(_localizationService.GetResource("Plugins.Widgets.ProductsSlider.trialEnd"));
            //}
            ...
            //prepare model
            var model = _productSliderModelFactory.PrepareProductSliderSearchModel(new ProductSliderSearchModel());
        ...
        [HttpPost]
        public virtual IActionResult List(ProductSliderSearchModel searchModel)
        {
            if (!_permissionService.Authorize(ProductsSliderPlugin.ManageProductSliderPermission))
                return AccessDeniedDataTablesJson();
            //prepare model
            var model = _productSliderModelFactory.PrepareProductSliderListModel(searchModel);
        ...
        public virtual IActionResult Create(ProductSliderModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _notificationService.SuccessNotification(_localizationService.GetResource("Plugins.Widgets.ProductsSlider.ProductSliders.Added"));
        ...
        public virtual IActionResult Edit(ProductSliderModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _notificationService.SuccessNotification(_localizationService.GetResource("Plugins.Widgets.ProductsSlider.ProductSliders.updated"));
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            _notificationService.SuccessNotification(_localizationService.GetResource("Plugins.Widgets.ProductsSlider.ProductSliders.Deleted"));
            return RedirectToAction("List");
        }
        ...
        public virtual IActionResult Settings(ProductSliderSettingsModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _notificationService.SuccessNotification(_localizationService.GetResource("Plugins.Widgets.ProductsSlider.ProductSliders.settingsupdated"));
